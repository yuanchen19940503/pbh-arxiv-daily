...
更新结果见：https://yuanchen19940503.github.io/pbh-arxiv-daily/

## 中文说明

### 1. 项目简介
本项目用于每天抓取 arXiv 的 `gr-qc/new` 与 `astro-ph/new`（可自行修改），在“New submissions + Cross-lists”中检索与原初黑洞相关的论文，并生成：
- 当天批次的 JSON 文件（永久保存）
...
- **关键词匹配**：当前匹配的关键词为 PBH(s) / primordial black hole(s) （可自行修改）
